...
export function AppShell() {
  ...
  const windowTitle = activeCwdName ? `${activeCwdName} - oh-my-web` : "oh-my-web";
        ...
        {([
          {
            ...
            icon: (
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="4" y="4" width="14" height="14" rx="2" /><rect x="9" y="9" width="6" height="6" />
    ...
    return (
      <div style={{ display: "flex", alignItems: "stretch", height: "100%" }}>
        ...
        {mobile ? (
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: branchTree.length > 0 ? "var(--accent)" : "var(--text-muted)" }} aria-hidden="true">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: systemPrompt ? "var(--accent)" : "var(--text-muted)", flexShrink: 0 }} aria-hidden="true">
  ...
  const renderMainFileToggle = (mobile: boolean) => {
    ...
    return (
      ...
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          <rect x="3" y="3" width="14" height="14" rx="2" /><line x1="15" y1="3" x2="15" y2="21" />
        </svg>
      </button>
    );
  };
        ...
        <div style={{ display: "flex", alignItems: "center", position: "relative", borderBottom: "1px solid var(--border)", height: "calc(36px + env(safe-area-inset-top))", paddingTop: "env(safe-area-inset-top)" }}>
          <button
            ...
            style={{
              ...
              background: "none", border: "none", borderRight: "1px solid var(--border)",
              color: "var(--text-muted)", cursor: "pointer", flexShrink: 0, transition: "color 0.12s",
              // When the file panel is open and the sidebar is collapsed, the
              // top-left toggle is redundant; hide it (panel can be closed via
              // its own header button / the top-right toggle).
              visibility: rightPanelOpen && !sidebarOpen ? "hidden" : "visible",
            }}
