...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "appUpdate.releaseNotes": "oh-my-web v{version} is available. View release notes",
    "piUpdate.newVersionAvailable": "New pi version v{version} available",
    "piUpdate.currentInstalled": "Current v{version}",
    "piUpdate.oneClickUpdate": "Update Now",
    "piUpdate.updating": "Updating…",
    "piUpdate.updateSuccess": "Updated to v{version}! Please restart service",
    "piUpdate.updateFailed": "Update failed: {error}",
    "piUpdate.dismiss": "Dismiss",
