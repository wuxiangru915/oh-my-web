...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.skills": "技能",
    "common.plugins": "插件",
    "appUpdate.releaseNotes": "oh-my-web v{version} 可用，查看更新说明",
    "piUpdate.newVersionAvailable": "发现新的 pi 版本 v{version}",
    "piUpdate.currentInstalled": "当前版本 v{version}",
    "piUpdate.oneClickUpdate": "一键更新",
    "piUpdate.updating": "正在更新…",
    "piUpdate.updateSuccess": "更新成功！已升级至 v{version}，请重启服务",
    "piUpdate.updateFailed": "更新失败：{error}",
    "piUpdate.dismiss": "忽略",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
